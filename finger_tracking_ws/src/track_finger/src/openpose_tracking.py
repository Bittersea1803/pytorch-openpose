...
images = ['./triangle.jpg', './star.jpg', './quatrefoil.jpg', './heart.jpg','./house0.jpg','./house2.jpg','./house1.jpg']
##
...
class OpenPoseTrack:
    def __init__(self):
        ...
        ## TODO 3-a: Initilaize attribute for image index
        self.image_index = 0
        self.state = 0
        ...
        if body:
            ...
            for i in range(len(self.drawing_points)-2):
                ...
                if cv2.norm(new_coordinate0 - new_coordinate1, cv2.NORM_L2) <= self.max_dist:
                    ...
                    ## TODO 1-a: Color mode for single color
    ...
    def callback(self, msg):
        ...
        x = self.drawing_points[-1][0]
        y = self.drawing_points[-1][1]
        if x>280 and y<40:
        ...
        ##
            ...
            self.state = 1
        elif key_press == ord('b') and self.state==1:
            self.color_mode = 'blue'
            self.state = 0


        
        ## TODO 1-b: Color mode for single color
        elif key_press == ord('c'):
            self.color_mode = 'purple'
        ##
        ## TODO 3-c: Change image selection
